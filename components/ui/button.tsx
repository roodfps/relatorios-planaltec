 ...
 * - Todas as cores vêm de app/globals.css (bg-primary, text-foreground, etc)
 * - NUNCA use cores hardcoded aqui ou em qualquer lugar
 * 
 * Exemplo correto de uso:
 * - ✅ <Button variant="primary">Botão</Button> (usa bg-primary do tema)
 * - ❌ <Button className="bg-[#6c5ce7]">Botão</Button>
 * 
